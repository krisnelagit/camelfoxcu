...
//                $("#divPrint11").append($("#table_id").eq(0).clone()).html();
    ...
    <body>
        <a href="#" onclick="javascript:demoFromHTML()" class="view button-001">Send Mail</a>  <a href="viewCustomerDetailsLink?customerid=${sessionScope.CUSTOMERID}" class="view button-001">Back</a><a href="#" class="view button-001" onclick="CallPrint('printdiv')">Print</a>
        <c:choose>
