        ...
        <div id="testcase">
            <div id="printdiv">
                ...
                <div class="box2" align="right" style="display: inline-block; float: right">
                    ...
                    <strong>Job No</strong>&nbsp;:	<c:choose>
                        <c:when test="${empty invoiceDt.jobno}">
                            N/A
                        </c:when>
                        <c:otherwise>
                            ${invoiceDt.jobno}
                    ...
                    <strong>Date</strong> :<fmt:formatDate type="date" value="${invoiceDt.modifydate}" /> <br />
                    <strong>Vehicle Make &nbsp;:</strong>${invoiceDt.make} &nbsp; ${invoiceDt.vehiclename}<br />
                    <strong>Vehicle No. &nbsp;:</strong>${invoiceDt.vehiclenumber}<br />
                </div>
                <br />
                <br />
                <br />
