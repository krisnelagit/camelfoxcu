...
<!--        
        ...
        <form action="insertFeedback" id="questionaire" method="POST">
            ...
            <input type="hidden" name="customerid" value="${invoicedtls.customerid}" />
            ...
            <table cellpadding="5" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td align="left" valign="top" colspan="2" ><textarea name="question6" maxlength="600" id="textarea" rows="8" cols="90"></textarea><div id="textarea_feedback"></div></td>
                    </tr>
                    <tr>
