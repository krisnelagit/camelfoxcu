...
public class CustomerVehicles {
    ...
    private String custid, licensenumber, carbrand, carmodel, vehiclenumber, km_in,is180ready = "No", vinnumber, date, brandid, branddetailid, isdelete = "No", modifydate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Calendar.getInstance().getTime());

    public CustomerVehicles() {
    }

    public CustomerVehicles(String id, String savedate, String custid, String licensenumber, String carbrand, String carmodel, String vehiclenumber, String km_in, String vinnumber, String date, String brandid, String branddetailid) {
        this.id = id;
