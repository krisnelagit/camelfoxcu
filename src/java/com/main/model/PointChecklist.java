...
public class PointChecklist {
    @Id
    private String id;
    private String date,customervehiclesid,servicechecklistid,isestimate="No",isdelete="No",modifydate=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Calendar.getInstance().getTime());
