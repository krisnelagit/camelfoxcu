...
public class GeneralIncome {
    @Id
    private String id;
    private String ledgerid,towards,tax,taxid,income_date,tax_applicable,vat_tax,service_tax,vat_service_tax,invoiceid="",bank_accountid,status,amount,vouchernumber,total,mode,chequenumber="",bankname="",chequedate="",transactionnumber="",transactiondate="",isdelete="No",modifydate=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Calendar.getInstance().getTime());

    public GeneralIncome(String id, String ledgerid, String towards, String tax, String taxid, String income_date, String tax_applicable, String vat_tax, String service_tax, String vat_service_tax, String bank_accountid, String status, String amount, String vouchernumber, String total, String mode) {
        this.id = id;
