...
public class JobsheetDetails {
    ...
    private String estimatedetailid, jobsheetid, mfgid, verified = "No", workmanid, isdelete = "No", modifydate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Calendar.getInstance().getTime());

    public JobsheetDetails() {
    }

    public JobsheetDetails(String id, float estimatetime, String estimatedetailid, String jobsheetid, String mfgid, String workmanid) {
        this.id = id;
